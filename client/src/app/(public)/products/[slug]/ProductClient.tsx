...
export default function ProductClient({ product }: { product: Product }) {
    ...
    const contactNumber = product.whatsappNumber || '919015416940';
    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.ctaSection} style={{ backgroundImage: `linear-gradient(rgba(11, 22, 40, 0.55), rgba(11, 22, 40, 0.95)), url('https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=1600&q=80')` }}>
                <div className={styles.ctaContent}>
                    <h2 className={styles.ctaTitle}>Need a Custom Quote or Bulk Pricing?</h2>
                    <p className={styles.ctaDescription}>
                        Our steel experts are here to assist you with specific steel grades, custom thicknesses, sizing tolerances, and scheduling dispatches.
                    </p>
                    <div className={styles.ctaButtons}>
                        <a href="/contact-us" className={styles.ctaPrimaryBtn}>
                            Contact Us
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
