// Original hardcoded Home page, preserved untouched. Not a route (filename
// isn't "page.tsx"), rendered as a fallback by ./page.tsx. To fully restore
// this as the live homepage, flip BUILDER_HOME_ENABLED to false in page.tsx
// (or delete/unpublish the CMS "home" Page doc) — no other change needed.
