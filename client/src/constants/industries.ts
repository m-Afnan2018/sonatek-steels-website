export const INDUSTRIES_DATA = {
  automotive: {
    hero: {
      ...
      title: "Precision Steel for Automotive Excellence",
      description: "Sonatek Steels provides high-grade flat steel products tailored for the automotive sector, ensuring durability, safety, and performance for OEMs and component manufacturers.",
      image: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=1200&q=80",
    },
    mission: {
      label: "Mission",
      title: "Driving the Future of Mobility",
      description: "Our commitment to the automotive industry goes beyond supply. We partner with manufacturers to deliver steel solutions that power the next generation of vehicles.",
    },
    stats: {
      label: "Impact",
      title: "A Global Operation in Steel",
      description: "We serve the leading automotive hubs in Northern India with precision and speed.",
      items: [
        { value: 10, suffix: "k+", label: "Tons per year" },
        { value: 3, suffix: "min", label: "Processing time" },
        { value: 22, suffix: "+", label: "OEM Partners" },
      ]
    },
    howHelp: {
    ...
    builtToDeliver: {
      ...
      subtitle: "With unmatched global access, full supply chain control, and trusted capacity, we deliver the speed, scale and certainty automotive brands rely on.",
      points: [
        { icon: "Globe", title: "Global reach", description: "Move vehicles and parts seamlessly across continents with access to over 60 ports and a network that handles 10 percent of global automotive trade." },
        { icon: "Settings2", title: "End-to-end automotive logistics", description: "We manage every step, from inbound parts and assembly to finished vehicle handling and final delivery, giving you full control of your supply chain." },
        { icon: "TrendingUp", title: "Proven scale", description: "With 3 million cars shipped annually and partnerships with top OEMs, we deliver reliable capacity and performance, even during demand surges." },
      ]
    },
    video: {
      label: "IN MOTION",
      title: "Driving Toyota to Dealerships Nationwide",
      description: "See how our precision steel products and logistics solutions support industry giants in their quest for excellence.",
      videoUrl: "https://cdn.pixabay.com/video/2021/01/24/62900-504780516_large.mp4"
    },
    services: {
      title: "OUR SERVICES",
      ...
      items: [
        ...
        { title: "Warehousing & Distribution", description: "From our Naraina warehouse, we move CR and HR steel coils and sheets to automotive OEMs and component manufacturers across Northern India, supporting your production schedule with speed, scale, and reliability.", image: "https://images.unsplash.com/photo-1494412519320-aa613dfb7738?w=800&q=80", href: "/services/port-services" },
    ...
    cta: {
      ...
      description: "Get solutions that fit your automotive manufacturing needs. Talk to a steel expert today.",
      btnText: "Contact Us",
      btnHref: "/contact-us",
  ...
  construction: {
    ...
    mission: {
      ...
      description: "We provide the structural backbone for India's growing infrastructure with reliable, high-quality steel products.",
    },
    stats: {
      label: "Impact",
      ...
      items: [
        { value: 15, suffix: "k+", label: "Projects Supported" },
        { value: 200, suffix: "k+", label: "Tons Delivered" },
    ...
    builtToDeliver: {
      ...
      points: [
        { icon: "Building2", title: "Structural Integrity", description: "High-tensile steel grades for maximum load-bearing capacity." },
        { icon: "Shield", title: "Corrosion Resistance", description: "Specialized coatings and treatments for long-lasting performance." },
        { icon: "Clock", title: "Project Timelines", description: "On-time delivery to keep your construction project on schedule." },
      ]
    },
    video: {
      label: "IN ACTION",
  ...
  "oil-gas": {
    ...
    mission: {
      ...
      description: "We provide high-performance steel that ensures the safety and efficiency of the energy sector.",
    },
    stats: {
      label: "Impact",
      ...
      items: [
        { value: 8, suffix: "+", label: "Energy Hubs Served" },
        { value: 120, suffix: "k+", label: "Tons Delivered" },
    ...
    builtToDeliver: {
      ...
      points: [
        { icon: "ShieldAlert", title: "Corrosion Resistance", description: "HIC and SSCC resistant steel grades for sour service environments." },
        { icon: "Thermometer", title: "Extreme Temperature", description: "Steel that maintains properties in both cryogenic and high-heat conditions." },
        { icon: "Search", title: "Rigorous Testing", description: "UT, MPI, and other non-destructive testing for guaranteed integrity." },
      ]
    },
    video: {
      label: "IN FOCUS",
  ...
  shipbuilding: {
    ...
    mission: {
      ...
      description: "We provide the durability and reliability needed to conquer the ocean's toughest challenges.",
    },
    stats: {
      label: "Impact",
      ...
      items: [
        { value: 5, suffix: "+", label: "Major Shipyards" },
        { value: 80, suffix: "k+", label: "Tons Supplied" },
        { value: 100, suffix: "%", label: "Class Certified" },
      ]
    },
    howHelp: {
    ...
    builtToDeliver: {
      ...
      points: [
        { icon: "Waves", title: "Saltwater Resistance", description: "Marine-grade alloys designed to minimize corrosion in high-salinity environments." },
        { icon: "Anchor", title: "Impact Strength", description: "Steel that maintains toughness even in sub-zero water temperatures." },
        { icon: "FileCheck", title: "Class Approval", description: "Steel plates certified by ABS, LR, DNV, and other major classification societies." },
      ]
    },
    video: {
      label: "IN ACTION",
  ...
  "heavy-engineering": {
    ...
    mission: {
      ...
      description: "We provide the structural foundation for the most demanding engineering feats with steel that never compromises on integrity.",
    },
    stats: {
      label: "Impact",
      ...
      items: [
        { value: 20, suffix: "+", label: "Major Hubs Served" },
        { value: 150, suffix: "k+", label: "Tons Delivered" },
        { value: 15, suffix: "+", label: "Engineering Giants" },
      ]
    },
    howHelp: {
    ...
    builtToDeliver: {
      ...
      points: [
        { icon: "Shield", title: "Extreme Durability", description: "Wear-resistant and high-tensile grades designed for mining and earthmoving." },
        { icon: "Settings", title: "Technical Precision", description: "Meeting the strict dimensional tolerances required for complex engineering." },
        { icon: "TrendingUp", title: "Supply Reliability", description: "Consistent supply of specialized alloys to keep production lines moving." },
      ]
    },
    video: {
      label: "IN MOTION",
  ...
  "fabricators-oems": {
    ...
    mission: {
      ...
      description: "Your growth is our priority. We simplify your supply chain so you can focus on manufacturing excellence.",
    },
    stats: {
      label: "Impact",
      ...
      items: [
        { value: 500, suffix: "+", label: "Local Fabricators" },
        { value: 50, suffix: "+", label: "Global OEMs" },
    ...
    builtToDeliver: {
      ...
      points: [
        { icon: "Zap", title: "High Versatility", description: "A wide range of grades and sizes in stock to meet diverse fabrication needs." },
        { icon: "CheckCircle", title: "Quality Consistency", description: "Standardized processing ensures every blank meets your manufacturing specs." },
        { icon: "Clock", title: "Efficiency Boost", description: "Reduced lead times help you maintain lean inventory and faster production cycles." },
      ]
    },
    video: {
      label: "IN ACTION",
